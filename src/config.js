...
// Screen real-estate reserved for UI. The top strip is a single-row floating
// HUD bar (score, combo, buttons). BOTTOM_BUTTON_HEIGHT is 0 because the
// back button now lives inside the HUD bar. Anything outside [HUD_HEIGHT,
// GAME_HEIGHT] is considered outside the playable area: paths whose start
// point lives there skip the auto-generated entry segment.
export const HUD_HEIGHT = 50;
export const BOTTOM_BUTTON_HEIGHT = 0;
...
export const SPLIT_FRONT_PULL_RATIO = 1.0;
export const SPLIT_FRONT_PULL_MAX = 54;
export const SPLIT_FRONT_PULL_MIN_RATIO = 1.0;
export const SPLIT_FRONT_PULL_CURVE = 0.6;
export const SPLIT_FRONT_PULL_SPEED = 220;
